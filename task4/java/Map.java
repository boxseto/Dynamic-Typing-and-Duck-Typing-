...
public class Map {
	...
	public void teleportPotion() {
		Pos posto, posfrom;
		for (Object obj : teleportable_obj) {
		    if (obj instanceof Potion) {
					posfrom = ((Potion) obj).getPos();
					this.setLand(posfrom, null);
					posto = this.getUnOccupiedPosition();
					this.setLand(posto, obj);
					((Potion) obj).setPos(posto);
			}
		}
	}
	...
	public void decreaseNumOfPotion() {
		this.numOfPotions--;
	}
