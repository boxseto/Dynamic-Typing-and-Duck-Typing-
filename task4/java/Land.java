...
public class Land{
	...
	public boolean coming(Warrior warrior) {
		if (occupied_obj instanceof Elf) {
			return ((Elf) occupied_obj).actionOnWarrior(warrior);
		} else if (occupied_obj instanceof Monster) {
			return ((Monster) occupied_obj).actionOnWarrior(warrior);
